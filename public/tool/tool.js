    ...
    LoadScene.prototype.loadAssets = function () {
        ...
        try {
            for (var _f = __values(this.cache.text.get("assets").split("\n")), _g = _f.next(); !_g.done; _g = _f.next()) {
                ...
                var tokens = s.split(" ");
                if (tokens.length == 2)
                    this.load.image(tokens[0], "/public/tool/res/" + tokens[1] + ".png");
                else if (tokens.length == 4)
                    this.load.spritesheet(tokens[0], "/public/tool/res/" + tokens[1] + ".png", { frameWidth: parseInt(tokens[2]), frameHeight: parseInt(tokens[3]) });
            }
        }
...
var WALLS = [
    { name: "Dungeon Wall", key: "wall_dungeon", file: "/public/tool/res/tileset/wall_dungeon", res: 16 },
    { name: "Wood Wall", key: "wall_wood", file: "/public/tool/res/tileset/wall_wood", res: 16 },
    { name: "Shadow Wall", key: "wall_shadow", file: "/public/tool/res/tileset/wall_shadow", res: 16 },
];
var GROUNDS = [
    { name: "Cave Floor", key: "ground_cave", file: "/public/tool/res/tileset/ground_cave", res: 16 },
    { name: "Lawn", key: "ground_grass", file: "/public/tool/res/tileset/ground_grass", res: 16 },
    { name: "Wood Floor", key: "ground_wood", file: "/public/tool/res/tileset/ground_wood", res: 16 },
];
var OVERLAYS = [
    { name: "Water", key: "overlay_water", file: "/public/tool/res/tileset/overlay_water", res: 16 },
    { name: "Hole", key: "overlay_hole", file: "/public/tool/res/tileset/overlay_hole", res: 16 },
];
var TOKENS = [
