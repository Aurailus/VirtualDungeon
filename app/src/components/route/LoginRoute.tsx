...
export default function LoginRoute({ onLogin }: Props) {
	...
	return (
		<div class='LoginRoute'>
			<div class='LoginRoute-Wrap'>
				<form class={'LoginRoute-Card ' + state} onSubmit={handleSubmit}>
					<div class='LoginRoute-FormContents'>
				...
				<p class='LoginRoute-Warning'>{warning}</p>
			</div>
		</div>
	);
}
