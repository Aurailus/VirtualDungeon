...
export default class UISidebar extends UIContainer {
	scene: MapScene;
	...
	elemHover(_x: number, _y: number): void { /* To be overridden. */ }
	elemUnhover(_x: number, _y: number): void { /* To be overridden. */ }

	elemClick(_x: number, _y: number): void { /* To be overridden. */ }
